    ...
    if (!pathName.includes("admin")) {
        return (
            <div className='py-5 px-5 md:px-12 lg:px-28'>
              ...
              <Link href={'/'} className="cursor-pointer"> <Image src={assets.logo} alt='logo' width={220} className=' sm:w-auto'/></Link>
                   <Link className='cursor-pointer' href={`/admin/bloglist`}> <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000000]'>dashboard <Image src={assets.arrow} alt='image'/></button></Link>
                </div>
